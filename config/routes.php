...
Router::connect("/admin/plugin/{:library}/{:args}", array('admin' => true, 'library' => 'li3b_core', 'controller' => 'pages', 'action' => 'view'), array('continue' => true, 'persist' => array(
	'controller', 'admin', 'library'
)));
 ...
 */
Router::connect("/", array('library' => 'li3b_core', 'controller' => 'pages', 'action' => 'view', 'args' => array('home'), 'persist' => false, 'continue' => false));
Router::connect("/page/{:args}", array('library' => 'li3b_core', 'controller' => 'pages', 'action' => 'view', 'args' => array('home'), 'persist' => false, 'continue' => false));
