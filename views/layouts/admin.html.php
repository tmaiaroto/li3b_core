...
<head>
	...
	<?php 
		echo $this->html->style(array('/li3b_core/css/bootstrap.min.css', '/li3b_core/css/bootstrap-responsive.min.css', '/li3b_core/css/font-awesome', 'http://ajax.googleapis.com/ajax/libs/jqueryui/1/themes/smoothness/jquery-ui.css', '/li3b_core/css/jquery/tipsy.css', '/li3b_core/css/admin'), array('inline' => false));	
	?>
	<!--[if lt IE 9]>
	...
	<?php
		echo $this->html->script(array('https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.11/jquery-ui.min.js', '/li3b_core/js/jquery/jquery.tipsy.js', '/li3b_core/js/tiny_mce/tiny_mce.js', '/li3b_core/js/bootstrap.min.js', '/li3b_core/js/tiny_mce/jquery.tinymce.js'), array('inline' => false));
	?>
	<?php
		echo $this->scripts();
		echo $this->styles();
